...
class Controller(BoxLayout):
    ...
    def spinner_sel_chan2_inst(self, value):
        Sys_Variables.chan2_inst = value
    def spinner_sel_chan3_inst(self, value):
        Sys_Variables.chan3_inst = value
        print("Instrument Selected: " + Sys_Variables.instrument)
...
class ActionApp(App):
    ...
    chan2_inst_val = Sys_Variables.instrument_list
    chan3_inst_val = Sys_Variables.instrument_list
    file_path = ''
