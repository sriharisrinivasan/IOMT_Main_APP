...
def pitch_recognize(pitch):
    ...
    if pitch == 'C':
        pitch_value = 60
    elif pitch == 'Cs' or pitch == 'Df' or pitch == 'C SHARP' or pitch == 'D FLAT':
        pitch_value = 61
    elif pitch == 'D':
        pitch_value = 62
    elif pitch == 'Ds' or pitch == 'Ef' or pitch == 'D SHARP' or pitch == 'E FLAT':
        pitch_value = 63
    elif pitch == 'E':
        pitch_value = 64
    elif pitch == 'F':
        pitch_value = 65
    elif pitch == 'Fs' or pitch == 'Gf' or pitch == 'F SHARP' or pitch == 'G FLAT':
        pitch_value = 66
    elif pitch == 'G':
        pitch_value = 67
    elif pitch == 'Gs' or pitch == 'Af' or pitch == 'G SHARP' or pitch == 'A FLAT':
        pitch_value = 68
    elif pitch == 'A':
        pitch_value = 69
    elif pitch == 'As' or pitch == 'Bf' or pitch == 'A SHARP' or pitch == 'B FLAT':
        pitch_value = 70
    elif pitch == 'B':
        pitch_value = 71
    else:
